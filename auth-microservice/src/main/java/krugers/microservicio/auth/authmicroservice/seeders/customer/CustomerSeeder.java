...
public class CustomerSeeder {
    ...
    public void fillCustomersToDB(){
        ...
        addressesKev.add(new Address(2L,"Pichincha","Quito","Es dirección del trabajo","Calle 14",true,1L,"CREATED",new Date(), new Date()));
        ...
        addressesKen.add(new Address(4L,"Guayas","Guayaquil","Es dirección del trabajo","Calle 14",true,2L,"CREATED",new Date(), new Date()));
