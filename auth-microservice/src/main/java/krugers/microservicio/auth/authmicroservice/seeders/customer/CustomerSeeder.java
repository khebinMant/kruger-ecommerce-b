...
public class CustomerSeeder {
    ...
    public void fillCustomersToDB(){
        ...
        userServiceImpl.save(new User(1L,"kevin@yopmail.com","12345678","Kevin","Mantilla","0986261197",new Date(),new Date(), "https://avatars.githubusercontent.com/u/33032880?v=4",1L,addressesKev, true, Role.CUSTOMER));
