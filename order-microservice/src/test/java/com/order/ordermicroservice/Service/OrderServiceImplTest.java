...
public class OrderServiceImplTest {
    ...
    public void test_findOrderAll() {
        ...
        customOrders.add(new Order(200L, 2.10, new Date(), "SUCCES", "Bosque E3", new Date(), null));
        customOrders.add(new Order(300L, 3.30, new Date(), "SUCCES", "Chulmanova 5a", new Date(), null));
    ...
    public void test_getOrder() {
        ...
        Order customOrder = new Order(300L, 3.30, new Date(), "SUCCES", "Chulmanova 5a", new Date(), null);
